...
// Shortcode to display Portfolio Categories	
	function gc_display_portfolio_categories() {
     ob_start(); ?>
...
add_shortcode('portfolio-categories', 'gc_display_portfolio_categories');

//* Modify the length of post excerpts
add_filter( 'excerpt_length', 'gc_excerpt_length' );
function gc_excerpt_length( $length ) {
	return 75; // pull first 50 words
}